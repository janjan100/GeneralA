...
* The header should have a black background, tan links, etc. <!--nver linked style sheet>
* The logo is huge! It shouldn't be more than 70px <!--needs max widths>
* The typography on the introduction looks off - why is the text sans serif?<!--nevr included class to apply to>
